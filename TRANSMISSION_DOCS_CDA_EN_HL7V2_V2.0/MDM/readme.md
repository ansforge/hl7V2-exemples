Vous trouverez ici un exemple de message MDM HL7v2.6 et les acquittements correspondants, relatifs au volet "Transmission de document(s) CDA en HL7v2, SEGUR du numérique - Vague 2":
